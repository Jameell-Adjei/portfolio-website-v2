...
const Footer: React.FC = () => {
  return (
    <nav className="footer">
      <a href="mailto:jameelladjei@gmail.com" className="footer__link">
      ...
      <a
        href="https://github.com/Jameell-Adjei?tab=repositories"
        target="_blank"
      ...
      <a
        href="https://jameell-adjei.github.io/portfolio-website/static/media/Resume.f5c3db02.pdf"
        target="_blank"
        rel="noopener noreferrer"
        className="footer__link"
      >
